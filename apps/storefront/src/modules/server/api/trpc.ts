 ...
 *
 * Note: During Static Rendering, getServerAuthSession() will throw an error because it expects a request object available.
 *       The .catch(() => null) is used to capture the error and return null instead to allow Static Rendering to continue
 *
