...
const DynamicOneStepCheckout = dynamic(
  () =>
    import('@oriuminc/checkout-app-router').then((mod) => mod.OneStepCheckout),
  { ssr: false }
)

export const OneStepExperience = () => {
  const intl = useIntl()
