import { CONSTRUCTOR_CONSTANT } from '../../global-search-shared'
type HistoryItem = {
  id: string
  label: string
}
...
function isLocalStorageSupported(): boolean {
  try {
    localStorage.setItem(CONSTRUCTOR_CONSTANT.LOCAL_STORAGE_KEY_TEST, '')
    localStorage.removeItem(CONSTRUCTOR_CONSTANT.LOCAL_STORAGE_KEY_TEST)
    return true
  } catch (error) {
