import { COMMERCETOOLS_CONSTANT } from '../../global-search-shared'
...
function isLocalStorageSupported(): boolean {
  try {
    localStorage.setItem(COMMERCETOOLS_CONSTANT.LOCAL_STORAGE_KEY_TEST, '')
    localStorage.removeItem(COMMERCETOOLS_CONSTANT.LOCAL_STORAGE_KEY_TEST)
    return true
  } catch (error) {
